  ...
  return (
    <main className="mx-auto max-w-5xl space-y-8">
      ...
      <section className="space-y-6 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        ...
        <button type="button" onClick={startInterview} disabled={!canStart} className="rounded-xl bg-primary-500 px-6 py-3 font-semibold text-white disabled:opacity-50">
          开始文本面试
        </button>
      </section>
